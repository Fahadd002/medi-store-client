          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <Input
                ...
                placeholder="Email *"
                required
                className="focus:ring-emerald-500 text-gray-900 placeholder:text-gray-500"
                disabled={isLoading}
              />
            </div>
            ...
            <div>
              <div className="relative">
                <Input
                  ...
                  required
                  className="focus:ring-emerald-500 pr-10 text-gray-900 placeholder:text-gray-500"
                  disabled={isLoading}
                />
                <button
                  type="button"
